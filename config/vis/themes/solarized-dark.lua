...
lexers.STYLE_FUNCTION_BUILTIN = 'fore:'..colors.blue
lexers.STYLE_FUNCTION_METHOD = 'fore:'..colors.blue
...
lexers.STYLE_EMBEDDED = 'back:'..colors.base02
...
-- Diff
lexers.STYLE_ADDITION = 'fore:'..colors.green
lexers.STYLE_DELETION = 'fore:'..colors.red
lexers.STYLE_CHANGE = 'fore:'..colors.yellow
...
lexers.STYLE_ENVIRONMENT = lexers.STYLE_KEYWORD
lexers.STYLE_ENVIRONMENT_MATH = lexers.STYLE_NUMBER

-- Makefile
lexers.STYLE_TARGET = lexers.STYLE_KEYWORD
...
lexers.STYLE_HR = 'fore:'..colors.red
for i=1, 6 do lexers['STYLE_HEADING_H'..i] = 'fore:'..colors.red end
...
-- Meson
lexers.STYLE_OBJECT = lexers.STYLE_TYPE
...
lexers.STYLE_H1 = lexers.STYLE_HEADING
lexers.STYLE_H2 = lexers.STYLE_HEADING
lexers.STYLE_H3 = lexers.STYLE_HEADING
lexers.STYLE_H4 = lexers.STYLE_HEADING
lexers.STYLE_H5 = lexers.STYLE_HEADING
