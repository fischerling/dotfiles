# Copyright by the fish-shell contributors
# Taken from the fish-shell distribution licensed under GPLv2
# https://github.com/fischerling/dotfiles.git
function fish_add_path_fallback --description 'Add paths to the PATH'
    ...
    for path in $argv
        ...
        set -l p (realpath -s -- $path 2>/dev/null)
